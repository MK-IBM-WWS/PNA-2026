...
Кнопки циферблата: 0-9 и точка относятся к классу my-btn:
...
...
Кнопки второстепенных операций (C, +/-, %) принадлежат классам my-btn и secondary:
...
...
Кнопки первостепенных операций принадлежат к классам my-btn и primary:
...
Кнопка “=” дополнительно относится еще и к классу execute:

<button id="btn_op_equal" class="my-btn primary execute">=</button>
Блок с экраном калькулятора относим к классу result:
